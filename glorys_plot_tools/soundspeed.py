...
def populate_c_vals(file_path):
    try:
        ...
        with nc.Dataset(file_path, 'a', format='NETCDF4') as dataset:
            ...
            print('Computing soundspeed calculations...')
...
if __name__ == '__main__':
    populate_c_vals('cmems_mod_glo_phy_my_0.083deg_P1D-m_multi-vars_80.00W-42.00W_30.00N-53.00N_0.49-380.21m_1993-06-01-1993-06-05.nc')
